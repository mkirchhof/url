...
# def test_decoder(serialized_example):
#     return test_fn(serialized_example)
#
# class MyDecoder(tfds.decode.Decoder):
#     def __init__(self):
#         super().__init__()
...
#         decoded_data = test_fn(serialized_example)  # Call your 'fun' function
#         return decoded_data
#
#     def decode_example_shape(self, example):
#         # Define the shapes of the decoded tensors
#         return {"image": tf.TensorShape([]), "label": tf.TensorShape([])}
#
...
class DSpritesData(ImageTfdsData):
