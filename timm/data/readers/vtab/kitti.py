...
class KittiData(ImageTfdsData):
  ...
  def __init__(self, task, data_dir=None):
    ...
    # The original VTAB benchmark uses kitti:3.1.0, but this is deprecated and
    # incompatible with current TFDS. Changed it to 3.3.0.
