...
class RetinopathyData(ImageTfdsData):
  ...
  def heavy_train_augmentation(self):
    return self._heavy_train_augmentation  # TODO: Do we need this? If yes, make it compatible with timm.
                                           # TODO: we could pass this as postprocess_fn
  ...
  def get_tf_data(self,
    ...
    if self._heavy_train_augmentation and not for_eval:
      preprocess_fn = compose_preprocess_fn(
